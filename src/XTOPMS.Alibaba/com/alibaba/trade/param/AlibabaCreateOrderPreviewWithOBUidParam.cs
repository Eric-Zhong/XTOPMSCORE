...
public class AlibabaCreateOrderPreviewWithOBUidParam : GatewayAPIRequest {

    public AlibabaCreateOrderPreviewWithOBUidParam() {
        this.ApiId = new APIId("com.alibaba.trade", "alibaba.createOrder.previewWithOBUid",1);
	}
