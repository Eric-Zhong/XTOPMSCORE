...
public class AlibabaTradeGetSellerOrderListParam : GatewayAPIRequest {

    public AlibabaTradeGetSellerOrderListParam() {
        this.ApiId = new APIId("com.alibaba.trade", "alibaba.trade.getSellerOrderList",1);
	}
...
服务类的交易流程(50080)     *
    ...
    */
    ...
    public void setSellerRateStatus(int sellerRateStatus) {
        ...
        [DataMember(Order = 18)]
    private bool? tousuStatus;
    
        /**
       * @return 是否查找投诉中的地拟改单
    */
        public bool? getTousuStatus() {
               	return tousuStatus;
            }
     ...
     * 参数示例：<pre>true,false</pre>     
             * 此参数必填
          */
    public void setTousuStatus(bool tousuStatus) {
