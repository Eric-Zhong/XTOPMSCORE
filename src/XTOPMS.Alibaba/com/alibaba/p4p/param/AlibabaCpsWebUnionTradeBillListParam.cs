...
public class AlibabaCpsWebUnionTradeBillListParam : GatewayAPIRequest {

    public AlibabaCpsWebUnionTradeBillListParam() {
        this.ApiId = new APIId("com.alibaba.p4p", "alibaba.cps.webUnionTradeBillList",1);
	}
	
       [DataMember(Order = 1)]
    private string webUnionKey;
    
        /**
       * @return 网盟appKey
    */
        public string getWebUnionKey() {
               	return webUnionKey;
            }
     ...
     * 参数示例：<pre>000</pre>     
             * 此参数必填
          */
    public void setWebUnionKey(string webUnionKey) {
     	         	    this.webUnionKey = webUnionKey;
     	        }
