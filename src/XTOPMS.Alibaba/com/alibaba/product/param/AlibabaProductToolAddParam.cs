...
public class AlibabaProductToolAddParam : GatewayAPIRequest {

    public AlibabaProductToolAddParam() {
        this.ApiId = new APIId("com.alibaba.product", "alibaba.product.tool.add",1);
	}
