...
public class AlibabaProductTemplateCreateModel3DParam : GatewayAPIRequest {

    public AlibabaProductTemplateCreateModel3DParam() {
        this.ApiId = new APIId("com.alibaba.product", "alibaba.product.template.create.model3D",1);
	}
