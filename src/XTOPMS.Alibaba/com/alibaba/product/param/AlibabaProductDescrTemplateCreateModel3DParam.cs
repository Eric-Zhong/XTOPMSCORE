...
public class AlibabaProductDescrTemplateCreateModel3DParam : GatewayAPIRequest {

    public AlibabaProductDescrTemplateCreateModel3DParam() {
        this.ApiId = new APIId("com.alibaba.product", "alibaba.product.descr.template.create.model3D",1);
	}
