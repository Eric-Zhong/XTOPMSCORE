...
public class AlibabaProductDescrTemplateCreateStdParam : GatewayAPIRequest {

    public AlibabaProductDescrTemplateCreateStdParam() {
        this.ApiId = new APIId("com.alibaba.product", "alibaba.product.descr.template.create.std",1);
	}
