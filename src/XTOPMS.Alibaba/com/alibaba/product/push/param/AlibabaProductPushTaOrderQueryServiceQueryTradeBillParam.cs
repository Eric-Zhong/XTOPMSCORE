...
public class AlibabaProductPushTaOrderQueryServiceQueryTradeBillParam : GatewayAPIRequest {

    public AlibabaProductPushTaOrderQueryServiceQueryTradeBillParam() {
        this.ApiId = new APIId("com.alibaba.product.push", "alibaba.product.push.TaOrderQueryService.queryTradeBill",1);
	}
